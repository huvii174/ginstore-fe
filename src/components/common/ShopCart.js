                                ...
                                <div className="delivery">
                                    <div className="delivery-container">
                                        ...
                                        <div className="info info-input">
                                            <p style={{ display:  "block", width: "55px"}}>Họ tên</p>
                                            <input className='' onChange={handleChangeName}
                                                   placeholder='Họ tên' value={userLogin?.name}></input>
                                        </div>
										<div className="info info-input">
											<p style={{ display:  "block", width: "55px"}}>Phone</p>
											<input className='' onChange={handleChangePhone}
												   placeholder='09...' value={userLogin?.phone}></input>
										</div>
                                        <div className="info info-input">
											<p style={{ display:  "block", width: "55px"}}>Đ. chỉ</p>
											<input className='' onChange={handleChangeAddress}
												   placeholder='Địa chỉ' value={userLogin?.address}></input>
                                        </div>
                                        <div className="info info-input">
                                            <p style={{ display:  "block", width: "55px"}}>Ghi chú</p>
                                            <textarea className='' onChange={handleChangeNote}
                                                      placeholder='ghi chú ...'></textarea>
                                        </div>
                                        <div className="info info-input">
                                            <p style={{ display:  "block", width: "55px"}}>Thanh toán</p>

                                            <select className='form-control' onChange={handleChangeType} name='type'>
                                                <option value={1}>Thanh toán online</option>
                                                <option value={2}>Nhận hàng thanh toán</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div className="product-content">
                                                ...
                                                <div className="product-quantity">
													<span className="qty-decrease"
                                                          onClick={() => item.quantity === 1 ? setAlertMob(true) : dispatch(decrementQuantity(item))}>
														<img alt='d'
                                                             src='https://frontend.tikicdn.com/_mobile-next/static/img/icons/cartV2/decrease.svg'/>
													</span>
                                                    <span className="qty-input">{item.quantity}</span>
                                                    <span className="qty-increase"
                                                          onClick={() => dispatch(incrementQuantity(item))}>
														<img alt='d'
                                                             src='https://frontend.tikicdn.com/_mobile-next/static/img/icons/cartV2/increase.svg'/>
													</span>
                                                </div>
                                            </div>
                                        </div>
